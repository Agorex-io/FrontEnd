  ...
  TokensDropdown = (function(_React$Component) {
    function TokensDropdown(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (
          TokensDropdown.__proto__ || Object.getPrototypeOf(TokensDropdown)
        ).call(this, props)
      );
      return (
              ...
              return React.createElement(
                ...
                React.createElement(
                  "a",
                  {
                    ...
                    onClick: function(e) {
                      e.preventDefault();
                      _this2.selectToken.bind(_this2.self, token.addr)();
                      history.pushState(
                        null,
                        null,
                        "/#!/trade/" +
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: this.openModal.bind(this.self, "otherToken")
                    },
                    React.createElement("span", { className: "trn" }, "other")
                  )
                )
              )
            ];
