  ...
  Orders = (function(_React$Component) {
    function Orders(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (Orders.__proto__ || Object.getPrototypeOf(Orders)).call(this, props)
      );
      return (
        props.store.subscribe(function() {
          ...
          state.orders || (_this.scrolledToMid = !1),
            (_this.state.selectedAccount === state.selectedAccount &&
              _this.state.selectedContract === state.selectedContract &&
          ...
          value: function() {
            ...
            node &&
              ...
              (node.parentNode.parentNode.parentNode.scrollTop =
                node.offsetTop -
                node.parentNode.parentNode.parentNode.clientHeight / 2.0));
          }
        },
        {
                  ...
                  return order.expires > _this2.state.blockNumber
                    ? React.createElement(
                        ...
                        React.createElement(
                          "td",
                          {
                            className: "three-columns overflow-hidden"
                          },
                          React.createElement(
                            "span",
                            {
                            ...
                            _this2.weiToEth(
                              ...
                              _this2.getDivisor(_this2.state.selectedToken),
                              3
                            )
                          )
                        ),
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            _this2.weiToEth(
                              Math.abs(order.availableVolumeBase),
                              _this2.getDivisor(_this2.state.selectedBase),
                              3
                            )
                          )
                        )
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      "th",
                      {
                        className: "three-columns overflow-hidden padding-left"
                      },
                      React.createElement(
                        "span",
                        {
