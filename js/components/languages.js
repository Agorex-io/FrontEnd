      ...
      _createClass(Languages, [
        {
          ...
          value: function() {
            var _this2 = this,
              languagesMap = this.languages.map(function(language, i) {
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: _this2.selectLanguage.bind(_this2.self, language)
                    },
                    React.createElement("span", { className: "trn" }, language)
                  )
                );
              });
            return [
