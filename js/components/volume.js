  ...
  Volume = (function(_React$Component) {
    function Volume(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (Volume.__proto__ || Object.getPrototypeOf(Volume)).call(this, props)
      );
      return (
      ...
      _createClass(Volume, [
        ...
        },
        {
          ...
          value: function() {
            ...
            for (var pairVolumes = [], j = 0; j < this.bases.length; j += 1)
              for (var i = 0; i < this.tokens.length; i += 1) {
                var token = this.getToken(this.tokens[i]),
                  base = this.getToken(this.bases[j]);
                if (token && base) {
                  var rt = Object.values(this.state.returnTicker).find(function(
                      t
                    ) {
                  ...
                  rt &&
                    Object.assign(pairVolume, {
                      quoteVolume: Math.round(rt.quoteVolume),
                    ...
                    this.bases.map(function(base, index) {
                      return React.createElement(
                        ...
                        React.createElement(
                          "a",
                          {
                            href: "#volume_" + base.name,
                            "aria-controls": "volume_" + base.name,
                            role: "tab",
                            "data-toggle": "tab"
                          },
                          base.name
                    ...
                    this.bases.map(function(base, index) {
                      return React.createElement(
                        "div",
                        {
                          ...
                          role: "tabpanel",
                          className:
                            "tab-pane" + (0 === index ? " active" : ""),
                          id: "volume_" + base.name
                        },
                        React.createElement(
                          "table",
                          {
                            className: "table table-condensed table-borderless"
                          },
                          React.createElement(
                            "thead",
                            null,
                            React.createElement(
                              ...
                              React.createElement(
                                "th",
                                {
                                  className: "trn four-columns overflow-hidden"
                                },
                                "token"
                              ),
                              React.createElement(
                              ...
                              React.createElement(
                                "th",
                                {
                                  className: "four-columns overflow-hidden"
                                },
                                React.createElement(
                                  "span",
                                  {
                          ...
                          React.createElement(
                            ...
                            pairVolumes
                              .filter(function(x) {
                                return x.base.name === base.name;
                              })
                              .map(function(pairVolume, i) {
                                return React.createElement(
                                  "tr",
                                  { key: i },
                                  React.createElement(
                                    ...
                                    React.createElement(
                                      "a",
                                      {
                                        href:
                                          "/#!/trade/" +
                                          pairVolume.token.name +
                                          "-" +
                                          pairVolume.base.name,
                                        onClick: function(e) {
                                          e.preventDefault();
                                          _this2.selectTokenAndBase.bind(
                                            _this2.self,
                                            pairVolume.token.addr,
                                            pairVolume.base.addr
                                          )();
                                          history.pushState(
                                            null,
                                            null,
                                  ...
                                  React.createElement(
                                    ...
                                    Math.round(pairVolume.quoteVolume)
                                  ),
                                  React.createElement(
                                    "td",
                                    {
