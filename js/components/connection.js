  ...
  Connection = (function(_React$Component) {
    function Connection(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (Connection.__proto__ || Object.getPrototypeOf(Connection)).call(
          this,
          props
        )
      );
      ...
      _createClass(Connection, [
        {
          ...
          value: function() {
            ...
            var contractsMap = this.contracts.map(function(contract, i) {
              return React.createElement(
                "li",
                {
                  ...
                  style: {
                    background:
                      _this2.state.selectedContract === contract.addr
                        ? "#999"
                        : "#fff"
                  }
                },
