  ...
  Trades = (function(_React$Component) {
    function Trades(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (Trades.__proto__ || Object.getPrototypeOf(Trades)).call(this, props)
      );
      return (
      ...
      _createClass(Trades, [
        {
          ...
          value: function() {
            ...
            var tradesMap = this.state.trades.map(function(trade, i) {
              return React.createElement(
                "tr",
                { key: i },
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    isNaN(trade.price) ? (0).toFixed(9) : trade.price.toFixed(9)
                  )
                ),
                React.createElement(
                  "td",
