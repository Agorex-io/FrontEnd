      ...
      _createClass(Accounts, [
        {
          ...
          value: function() {
            var _this2 = this;
            if (!this.state.connection) return React.createElement("div", null);
            var badge = function(account) {
                return "MetaMask" === account.kind
                  ? React.createElement(
                      "span",
                      {
                        className:
                          "label " +
                          ("RPC" === _this2.state.connection.connection
                            ? "label-success"
                            : "label-warning")
                      },
                      "MetaMask"
                      ...
                      ? React.createElement(
                          "span",
                          {
                            className:
                              "label " +
                              ("PublicRPC" ===
                              _this2.state.connection.connection
                                ? "label-success"
                                : "label-warning")
                          },
                          "ForkDelta " +
                            ("PublicRPC" === _this2.state.connection.connection
                              ? "via MyEtherAPI"
                              : "") +
                            " (Private Key)"
                        )
              ...
              dropdown =
                ...
                this.state.selectedAccount < this.state.accounts.length
                  ? React.createElement(
                      ...
                      "... ",
                      void 0 !==
                      this.state.accounts[this.state.selectedAccount].balance
                        ? React.createElement(
                            "span",
                            { className: "badge" },
                            this.weiToEth(
                        ...
                        : void 0,
                      " ",
                      badge(this.state.accounts[this.state.selectedAccount]),
                      " ",
              ...
              accountsMap = this.state.accounts.map(function(account, i) {
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: _this2.selectAccount.bind(_this2.self, i)
                    },
                    account.addr,
                    " ",
                    void 0 !== account.balance
                      ? React.createElement(
                          "span",
                          { className: "badge" },
                          _this2.weiToEth(account.balance, void 0, 3),
                          " ETH"
                        )
                      : void 0,
                    " ",
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: this.createAccount.bind(this.self)
                    },
                    React.createElement(
                      "span",
                      { className: "trn" },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: this.openModal.bind(this.self, "importAccount")
                    },
                    React.createElement(
                      "span",
                      { className: "trn" },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: this.openModal.bind(this.self, "ledger")
                    },
                    React.createElement("span", { className: "trn" }, "ledger")
                  )
                ),
                this.state.accounts[this.state.selectedAccount] &&
                this.state.accounts[this.state.selectedAccount].addr
                  ? [
                      React.createElement(
                        "li",
                        { key: "1" },
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          {
                            href: "javascript:;",
                            onClick: this.showPrivateKey.bind(this.self)
                          },
                          React.createElement(
                            "span",
                            { className: "trn" },
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          {
                            href: "javascript:;",
                            onClick: this.deleteAccount.bind(this.self)
                          },
                          React.createElement(
                            "span",
                            { className: "trn" },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      href: "javascript:;",
                      onClick: this.openModal.bind(this.self, "gasPrice")
                    },
                    React.createElement(
                      "span",
                      { className: "trn" },
