  ...
  Balance = (function(_React$Component) {
    function Balance(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (Balance.__proto__ || Object.getPrototypeOf(Balance)).call(this, props)
      );
      return (
          ...
          value: function() {
            var _this2 = this,
              balanceDisplay = function(token) {
                var balance =
                  _this2.state.accounts[_this2.state.selectedAccount].balances[
                    token.addr
                  ];
                return React.createElement(
                  "table",
                  {
                    className: "table table-borderless table-balances"
                  },
                  React.createElement(
                    "tbody",
                    null,
                        ...
                        balance
                          ? React.createElement(
                              ...
                              _this2.weiToEth(
                                ...
                                _this2.getDivisor(balance.token),
                                3
                              ),
                              React.createElement(
                                "span",
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement("input", {
                            type: "text",
                            className: "form-control input-xs trn",
                            style: {
                              width: "195px"
                            },
                            ref: "depositAmount" + token.addr,
                            placeholder: "amount"
                          })
                        ),
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            {
                              type: "button",
                              className: "btn btn-primary btn-xs trn",
                              style: {
                                width: "80px"
                              },
              ...
              header = React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement("td", { className: "trn" }, "token"),
                    React.createElement(
                      "td",
                      {
                        className: "trn",
                    ...
                    React.createElement(
                      "td",
                      {
                        ...
                        "data-toggle": "tooltip",
                        "data-placement": "bottom",
                        title: "balance_etherdelta_tooltip"
                      },
                      "balance_etherdelta"
                    )
                  )
                  ...
                  : React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          header,
                          balanceDisplay(this.state.selectedToken),
                          depositForm(this.state.selectedToken),
                          balanceDisplay(this.state.selectedBase),
                          depositForm(this.state.selectedBase)
                        ),
                        React.createElement(
                          "div",
                          {
                          ...
                          header,
                          balanceDisplay(this.state.selectedToken),
                          withdrawForm(this.state.selectedToken),
                          balanceDisplay(this.state.selectedBase),
                          withdrawForm(this.state.selectedBase)
                        ),
                        React.createElement(
                          "div",
                          {
                          ...
                          header,
                          balanceDisplay(this.state.selectedToken),
                          transferForm(this.state.selectedToken),
                          balanceDisplay(this.state.selectedBase),
                          transferForm(this.state.selectedBase)
                        )
                      ),
                      React.createElement(
                        "div",
