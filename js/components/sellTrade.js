...
var _createClass = (function() {
  ...
  SellTrade = (function(_React$Component) {
    function SellTrade(props) {
      _classCallCheck(this, SellTrade);
      var _this = _possibleConstructorReturn(
        this,
        (SellTrade.__proto__ || Object.getPrototypeOf(SellTrade)).call(
          this,
          props
        )
      );
      return (
        ...
        props.store.subscribe(function() {
          var state = props.store.getState(),
            order = state.forms.sellOrder,
            sellCrossAmount = order
              ? _this.weiToEth(
          ...
          _this.setState({
            ...
            _this.refs.sellCrossAmount ||
              _this.setState({
                baseAmount: (sellCrossAmount * price).toFixed(3),
                feeAmount: (sellCrossAmount * price * 0.003).toFixed(3)
              });
        }),
        ...
        (_this.changeAmount = function() {
          var price = _this.state.order.price,
            sellCrossAmount = _this.refs.sellCrossAmount.value;
          _this.setState({
            baseAmount: (sellCrossAmount * price).toFixed(3),
            feeAmount: (0.003 * sellCrossAmount).toFixed(3)
          });
        }),
        (_this.tradeClick = function() {
          _this.closeModal.call(_this.self, _this.state.modal);
          var amount = _this.refs.sellCrossAmount.value,
            order = _this.state.order;
          _this.trade.call(_this.self, "sell", order, amount);
        }),
        _this
      );
    }
    return (
      _inherits(SellTrade, React.Component),
      _createClass(SellTrade, [
        {
          key: "render",
          value: function() {
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            null,
                            this.weiToEth(
                              Math.abs(this.state.order.availableVolume),
                            ...
                            "  @ ",
                            this.state.order.price.toFixed(9),
                            " ",
                            this.state.selectedToken.name,
                            "/",
                          ...
                          React.createElement(
                            ...
                            null,
                            "Expires in ",
                            this.state.order.expires - this.state.blockNumber,
                            " ",
                            React.createElement(
                              "span",
                              { className: "trn" },
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        "button",
                        {
                          ...
                          onClick: this.tradeClick.bind(this)
                        },
                        "sell"
                      )
                    )
