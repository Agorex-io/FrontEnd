                  ...
                  return order.expires > _this2.state.blockNumber
                    ? React.createElement(
                        ...
                        React.createElement(
                          "td",
                          null,
                          order.expires - _this2.state.blockNumber,
                          " ",
                          order.expires - _this2.state.blockNumber == 1
                            ? _this2.translator.get("block")
                            : _this2.translator.get("blocks")
                        ),
                        React.createElement(
                          "td",
                          null,
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          "button",
                          {
                            ...
                            className: "btn btn-primary btn-xs",
                            style: { width: "50px" },
                            onClick: _this2.cancelOrder.bind(_this2.self, order)
                          },
                          React.createElement(
                            "span",
                            { className: "trn" },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement("th", { className: "trn" }, "cancel")
                  )
                ),
                React.createElement(
                  "tbody",
